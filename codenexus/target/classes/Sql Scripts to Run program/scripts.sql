...
INSERT INTO user_course(progress, course_id, user_id) VALUES ('1', '3', '996');
INSERT into messages_entity(read, header, announcement, body, sender, recipient) values ('false', 'sub','false', 'text', '999', '995');
INSERT into messages_entity(read, header, announcement, body, sender, recipient) values ('false', 'sub','false', 'text', '999', '995');
INSERT into messages_entity(read, header, announcement, body, sender, recipient) values ('false', 'sub','false', 'text', '995', '998');
INSERT into messages_entity(read, header, announcement, body, sender, recipient) values ('false', 'sub','false', 'text', '995', '997');
INSERT into messages_entity(read, header, announcement, body, sender, recipient) values ('false', 'sub','false', 'text', '995', '996');
INSERT into messages_entity(read, header, announcement, body, sender, recipient) values ('false', 'sub','false', 'text', '999', '995');
INSERT into messages_entity(read, header, announcement, body, sender, recipient) values ('false', 'sub','false', 'text', '999', '994');
INSERT into messages_entity(read, header, announcement, body, sender, recipient) values ('false', 'sub','false', 'text', '995', '999');
INSERT into messages_entity(read, header, announcement, body, sender, recipient) values ('false', 'sub','false', 'text', '996', '999');
